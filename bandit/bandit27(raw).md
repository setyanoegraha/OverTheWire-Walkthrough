...
bandit24@bandit:/tmp/tmp.wuaaUvfCrE$ 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exi
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exi: command not found
bandit24@bandit:/tmp/tmp.wuaaUvfCrE$ exit
logout
Connection to bandit.labs.overthewire.org closed.

┌──(oubaitori㉿DESKTOP-GBJEDR2)-[~]
└─$ ssh bandit26@bandit.lab.overthewire.org -p 2220
ssh: Could not resolve hostname bandit.lab.overthewire.org: No address associated with hostname
...
┌──(oubaitori㉿DESKTOP-GBJEDR2)-[~]
└─$ ls
challenges  modul.py       open_security_training_2  py.py
havefun     new.sh         OverTheWire-Walkthrough   ssh_pwncollege
learn       OOP_TI1B_2025  pwncollege
...
┌──(oubaitori㉿DESKTOP-GBJEDR2)-[~]
└─$ ssh bandit26@┌──(oubaitori㉿DESKTOP-GBJEDR2)-[~]
└─$ ssh bandit26@bandit.labs.overthewire.org -p 2220
                         _                     _ _ _
                        | |__   __ _ _ __   __| (_) |_
                        | '_ \ / _` | '_ \ / _` | | __|
...
-rw-r-----  1 bandit26 bandit26   258 Sbandit26@bandit:~$ ./bandit27-do cat /etc/bandit_pass/bandit27
upsNCc7vzaRDx6oZC6GiR6ERwe1MowGB
